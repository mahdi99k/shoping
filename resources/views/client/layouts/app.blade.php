                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td class="text-center"><a href="product.html">
                                                    <img class="img-thumbnail" title="کفش راحتی مردانه" alt="کفش راحتی مردانه"
                        ...
                        <li class="menu_brands dropdown"><a href="#">برند ها</a>
                            <div class="dropdown-menu">
                                <div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"><a href="#">
                                        <img src="client/image/product/apple_logo-60x60.jpg" title="اپل" alt="اپل"/></a><a
                                        href="#">اپل</a></div>
            ...
            <div class="row">
                ...
                <div id="content" class="col-xs-12">
                    ...
                    <div class="slideshow single-slider owl-carousel">
                        <div class="item"><a href="#"><img class="img-responsive" src="client/image/slider/banner-2.jpg"
                                                           alt="banner 2"/></a></div>
                        <div class="item"><a href="#"><img class="img-responsive" src="client/image/slider/banner-1.jpg"
                                                           alt="banner 1"/></a></div>
                    </div>
                    <!-- Slideshow End-->
                    <!-- Banner Start-->
                    ...
                    <div id="product-tab" class="product-tab">
                            ...
                            <div class="owl-carousel product_carousel_tab">
                                <div class="product-thumb clearfix">
                                    <div class="image"><a href="product.html"><img
                                                src="client/image/product/apple_cinema_30-220x330.jpg" alt="تی شرت کتان مردانه"
                                ...
                                <div class="product-thumb clearfix">
                                    ...
                                    <div class="button-group">
                                        <button class="btn-primary" type="button" onClick="cart.add('49');"><span>افزودن به سبد</span>
                                        </button>
                                        <div class="add-to-links">
                                            <button type="button" data-toggle="tooltip" title="افزودن به علاقه مندی ها"
                                                    onClick=""><i class="fa fa-heart"></i></button>
                                ...
                                <div class="product-thumb clearfix">
                                    <div class="image"><a href="product.html"><img
                                                src="client/image/product/sony_vaio_1-220x330.jpg" alt="کفش راحتی مردانه"
                                    ...
                                    <div class="button-group">
                                        <button class="btn-primary" type="button" onClick="cart.add('46');"><span>افزودن به سبد</span>
                                        </button>
                                        <div class="add-to-links">
                                            <button type="button" data-toggle="tooltip" title="افزودن به علاقه مندی ها"
                                                    onClick=""><i class="fa fa-heart"></i></button>
                                ...
                                <div class="product-thumb clearfix">
                                    ...
                                    <div class="button-group">
                                        <button class="btn-primary" type="button" onClick="cart.add('43');"><span>افزودن به سبد</span>
                                        </button>
                                        <div class="add-to-links">
                                            <button type="button" data-toggle="tooltip" title="افزودن به علاقه مندی ها"
                                                    onClick=""><i class="fa fa-heart"></i></button>
                                ...
                                <div class="product-thumb clearfix">
                                    <div class="image"><a href="product.html"><img
                                                src="client/image/product/iphone_1-220x330.jpg" alt="آیفون 7" title="آیفون 7"
                                ...
                                <div class="product-thumb clearfix">
                                    <div class="image"><a href="product.html"><img
                                                src="client/image/product/canon_eos_5d_1-220x330.jpg"
                                                alt="تیشرت آستین بلند مردانه" title="تیشرت آستین بلند مردانه"
                                                class="img-responsive"/></a></div>
                                    <div class="caption">
                                        <h4><a href="product.html">تیشرت آستین بلند مردانه</a></h4>
                                        <p class="price"><span class="price-new">98000 تومان</span> <span
                                                class="price-old">122000 تومان</span> <span class="saving">-20%</span>
                                        </p>
                                    </div>
                                    <div class="button-group">
                                        <button class="btn-primary" type="button" onClick=""><span>افزودن به سبد</span>
                        ...
                        <div id="tab-latest" class="tab_content">
                            <div class="owl-carousel product_carousel_tab">
                                ...
                                <div class="product-thumb">
                                    <div class="image"><a href="product.html"><img
                                                src="client/image/product/nikon_d300_5-220x330.jpg" alt="محصولات مراقبت از مو"
                                ...
                                <div class="product-thumb">
                                    <div class="image"><a href="product.html"><img
                                                src="client/image/product/nikon_d300_4-220x330.jpg" alt="کرم لخت کننده مو"
                        ...
                        <div id="tab-special" class="tab_content">
                            <div class="owl-carousel product_carousel_tab">
                                <div class="product-thumb">
                                    <div class="image"><a href="product.html"><img
                                                src="client/image/product/ipod_touch_1-220x330.jpg" alt="سامسونگ گلکسی s7"
                                ...
                                <div class="product-thumb">
                                    <div class="image"><a href="product.html"><img
                                                src="client/image/product/macbook_air_1-220x330.jpg" alt="لپ تاپ ایلین ور"
                                ...
                                <div class="product-thumb">
                                    <div class="image"><a href="product.html"><img
                                                src="client/image/product/macbook_pro_1-220x330.jpg" alt=" کتاب آموزش باغبانی "
                        ...
                        <div class="category-module-content">
                            ...
                            <div id="tab-cat4" class="tab_content">
                                <div class="owl-carousel latest_category_tabs">
                                    ...
                                    <div class="product-thumb">
                                        <div class="image"><a href="product.html"><img
                                                    src="client/image/product/palm_treo_pro_1-220x330.jpg" alt="موبایل HTC M7"
                            ...
                            <div id="tab-cat5" class="tab_content">
                                <div class="owl-carousel latest_category_tabs">
                                    ...
                                    <div class="product-thumb">
                                        <div class="image"><a href="product.html"><img
                                                    src="client/image/product/ipod_classic_1-220x330.jpg" alt="آیپاد نسل 5"
                                    ...
                                    <div class="product-thumb">
                                        <div class="image"><a href="product.html"><img
                                                    src="client/image/product/ipod_nano_1-220x330.jpg" alt="پخش کننده موزیک"
                    ...
                    <div class="owl-carousel latest_category_carousel">
                        <div class="product-thumb">
                            <div class="image"><a href="product.html"><img src="client/image/product/iphone_6-220x330.jpg"
                        ...
                        <div class="product-thumb">
                            <div class="image"><a href="product.html"><img src="client/image/product/nikon_d300_5-220x330.jpg"
                        ...
                        <div class="product-thumb">
                            <div class="image"><a href="product.html"><img src="client/image/product/nikon_d300_4-220x330.jpg"
                                                                           alt="کرم لخت کننده مو"
                                                                           title="کرم لخت کننده مو"
                                                                           class="img-responsive"/></a></div>
                            <div class="caption">
                                <h4><a href="product.html">کرم لخت کننده مو</a></h4>
                                <p class="price"> 88000 تومان </p>
                        ...
                        <div class="product-thumb">
                            <div class="image"><a href="product.html"><img src="client/image/product/macbook_4-220x330.jpg"
                        ...
                        <div class="product-thumb">
                            <div class="image"><a href="product.html"><img src="client/image/product/macbook_3-220x330.jpg"
                        ...
                        <div class="product-thumb">
                            <div class="image"><a href="product.html"><img src="client/image/product/macbook_2-220x330.jpg"
                    ...
                    <div id="carousel" class="owl-carousel nxt">
                        <div class="item text-center"><a href="#"><img src="client/image/product/apple_logo-100x100.jpg"
                                                                       alt="پالم" class="img-responsive"/></a></div>
                        <div class="item text-center"><a href="#"><img src="client/image/product/canon_logo-100x100.jpg"
            ...
            <div class="container">
                ...
                <div class="bottom-row">
                    ...
                    <div class="payments_types"><a href="#" target="_blank"> <img data-toggle="tooltip"
                                                                                  src="clientimage/payment/payment_paypal.png"
                                                                                  alt="paypal" title="PayPal"></a> <a
                            href="#" target="_blank"> <img data-toggle="tooltip"
                                                           src="clientimage/payment/payment_american.png"
                                                           alt="american-express" title="American Express"></a> <a
                            href="#" target="_blank"> <img data-toggle="tooltip"
                                                           src="clientimage/payment/payment_2checkout.png" alt="2checkout"
                                                           title="2checkout"></a> <a href="#" target="_blank"> <img
                                data-toggle="tooltip" src="clientimage/payment/payment_maestro.png" alt="maestro"
                                title="Maestro"></a> <a href="#" target="_blank"> <img data-toggle="tooltip"
                                                                                       src="clientimage/payment/payment_discover.png"
                                                                                       alt="discover" title="Discover"></a>
                        <a href="#" target="_blank"> <img data-toggle="tooltip"
                                                          src="clientimage/payment/payment_mastercard.png" alt="mastercard"
