...
@section('titleWeb' , 'ایجاد رمز عبور')
    ...
    @include('client.composer.breadcrumbLoginRegister')
        ...
        <div class="row">
            ...
            <div class="col-sm-9" id="content">
                <h1 class="title">ایجاد رمز عبور جدید کاربری</h1>
                ...
                <form class="form-horizontal" method="post" action="{{ route('client.changeUserPassword.update') }}">
                    ...
                    <fieldset id="account" style="margin-bottom: 20px;margin-top: 50px">
                        <legend>لطفا رمز عبور جدید را تعیین کنید</legend>
                        ...
                        <div class="form-group required">
                            ...
                            <div class="col-sm-8">
                                <input type="password" name="password_confirm" class="form-control" id="input-email"
                                       placeholder="لطفا تکرار رمز عبور خود را وارد نمایید" style="border-radius: 3px" />
                            </div>
                        </div>
