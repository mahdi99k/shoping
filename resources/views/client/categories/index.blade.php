...
@section('titleWeb' , 'نمایش دسته بندی ها')
            ...
            <div class="row">
                ...
                <aside id="column-left" class="col-sm-3 hidden-xs">
                    ...
                    <div class="box-category">
                        ...
                        <ul id="cat_accordion">
                            <li class="cutom-parent-li"><a href="{{ route('client.category.index' , $category) }}" class="cutom-parent">مد و زیبایی<span
                ...
                <div id="content" class="col-sm-9">
                    ...
                    <div class="row products-category">
                       ...
                       @forelse ($category->getAllSubCategoryProducts() as $getProducts)  {{-- children --}}
